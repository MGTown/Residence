...
public class area implements cmd {
    ...
    public void getLocale() {
        ...
        c.get("list.Info", List.of("&eUsage: &6/res area list [residence] <page>"));
        LocaleManager.addTabCompleteSub(this, "list", "[residence]");

        c.get("listall.Description", "List coordinates and other Info for areas");
        c.get("listall.Info", List.of("&eUsage: &6/res area listall [residence] <page>"));
        ...
        c.get("remove.Info", List.of("&eUsage: &6/res area remove [residence] [areaID]"));
