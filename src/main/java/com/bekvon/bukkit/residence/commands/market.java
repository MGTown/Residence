...
public class market implements cmd {
    ...
    public void getLocale() {
        ...
        c.get("Info", List.of("&eUsage: &6/res market ? for more Info"));
        ...
        c.get("list.Info", List.of("&eUsage: &6/res market list [rent/sell]"));
        LocaleManager.addTabCompleteSub(this, "list", "rent%%sell");

        c.get("list.SubCommands.rent.Description", "Lists rentable residences.");
        c.get("list.SubCommands.rent.Info", List.of("&eUsage: &6/res market list rent"));

        c.get("list.SubCommands.sell.Description", "Lists for sale residences.");
        c.get("list.SubCommands.sell.Info", List.of("&eUsage: &6/res market list sell"));
        ...
        c.get("unsell.Info", List.of("&eUsage: &6/res market unsell [residence]"));
        ...
        c.get("autopay.Info", List.of("&eUsage: &6/res market autopay [residence] [true/false]"));
