        ...
        while (it.hasNext()) {
            ...
            if ((target instanceof Player) && (shooter instanceof Player)) {
                ...
                if (attacker != null) {
                    ...
                    if (srcarea != null && srcarea.equals(area) && srcarea.getPermissions().playerHas((Player) target, Flags.friendlyfire, FlagCombo.OnlyFalse) &&
...
//	    ent = attackevent.getEntity();
        if ((victim instanceof Player || tamedAnimal) && (damager instanceof Player || (damager instanceof Projectile && (((Projectile) damager)
            ...
            return (area != null || Residence.getInstance().getWorldFlags().getPerms(damager.getWorld().getName()).has(Flags.creeper, true)) && (area == null || area.getPermissions().has(Flags.creeper,
                    true));
        }
        return true;
    }
