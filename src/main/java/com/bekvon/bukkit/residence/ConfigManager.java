...
//	    conf.crea.createSection("Global.CompleteDisable");
        ...
        if (!conf.isList("Global.CommandLimits.Global.WhiteList"))
            conf.set("Global.CommandLimits.Global.WhiteList", List.of("some allowed command"));

        if (!conf.isList("Global.CommandLimits.Global.BlackList"))
            conf.set("Global.CommandLimits.Global.BlackList", List.of("some blocked command"));
    ...
    public void UpdateConfigFile() {
        ...
        DisabledWorldsList = c.get("Global.Optimizations.DisabledWorlds.List", List.of("worldNamesHere"));
...
//	DisableNoFlagMessageWorlds = c.get("Global.Optimizations.DisabledNoFlagMessage.Worlds", Arrays.asList(Bukkit.getWorlds().get(0).getName()));
        ...
        if (c.getC().isInt("Global.AntiGreef.RangeGap")) {
            ...
            ls = c.get("Global.AntiGreef.RangeGaps", List.of("all-8"));
        ...
        FlagsList = c.get("Global.AntiGreef.Flags.list", List.of("pvp"));
