...
public enum Flags {
    ...
    @Deprecated
    Flags(int id, int data, FlagMode flagMode, String desc, boolean enabled) {
        this(CMIMaterial.get(id, data), flagMode, desc, enabled);
    }

    Flags(CMIMaterial icon, FlagMode flagMode, String desc, boolean enabled) {
        this.icon = icon;
